...
import { BiTranferAlt, BiDollar } from "react-icons/bi";
...
const NFTDescription = ({ nft }) => {
  ...
  const [providence, setProvidence] = useState(false);
      ...
      <div className={Style.NFTDescription_box}>
        ...
        <div className={Style.NFTDescription_box_share}>
          ...
          <div className={Style.NFTDescription_box_share_box}>
            ...
            <BsThreeDots className={Style} onClick={() => openNFTMenu()} />
        ...
        <div className={Style.NFTDescription_box_profile}>
          ...
          <div className={Style.NFTDescription_box_profile_biding}>
            ...
            {providence && (
              <div className={Style.NFTDescription_box_profile_biding_card}>
                <NFTTabs dataTab={providenceArray} />
              </div>
            )}
            {owner && (
              <div className={Style.NFTDescription_box_profile_biding_card}>
